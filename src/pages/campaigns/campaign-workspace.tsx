...
const CATEGORY_OFFERS: Record<string, { segmentId: string; segmentName: string; productGroup: string; promotion: string; promoValue: string; expectedLift: number; marginImpact: number; overstockCoverage: number }[]> = {
  ...
  'Hair Color': [
    { segmentId: 'seg-1', segmentName: 'Change Makers', productGroup: 'Hair Color & Styling', promotion: 'New Styling Products 20% off', promoValue: '20% OFF', expectedLift: 88, marginImpact: -12, overstockCoverage: 25 },
    { segmentId: 'seg-2', segmentName: 'Vivid Creators', productGroup: 'Textured Hair & Care', promotion: 'Vivid Color Bundle', promoValue: 'Buy 2 Get 1', expectedLift: 82, marginImpact: -15, overstockCoverage: 40 },
    { segmentId: 'seg-3', segmentName: 'Professional Stylists', productGroup: 'Nails & Essentials', promotion: 'PRO Manicure Set Deal Buy 5 Get 5', promoValue: 'Buy 5 Get 5', expectedLift: 91, marginImpact: -10, overstockCoverage: 35 },
    { segmentId: 'seg-4', segmentName: 'First-Time Stylists', productGroup: 'Grooming & Innovation', promotion: 'Starter Kit Special Get $20 off', promoValue: 'Get $20 off', expectedLift: 75, marginImpact: -8, overstockCoverage: 20 },
  ],
  'Hair Care': [
...
const CATEGORY_CREATIVES: Record<string, { id: string; segmentId: string; segmentName: string; headline: string; subcopy: string; cta: string; tone: string; hasOffer: boolean; offerBadge: string; complianceStatus: string; reasoning: string; image: string; approved: boolean }[]> = {
  ...
  'Hair Color': [
    { id: 'cr-1', segmentId: 'seg-1', segmentName: 'Change Makers', headline: 'Transform Your Look', subcopy: 'New styling products to refresh your style', cta: 'Shop Color & Styling', tone: 'Exciting', hasOffer: true, offerBadge: '20% OFF New Styling Products', complianceStatus: 'approved', reasoning: 'New product discovery appeals to change makers', image: '/images/hair_color/WELLA17.jpg', approved: false },
    { id: 'cr-2', segmentId: 'seg-2', segmentName: 'Vivid Creators', headline: 'Defined, Healthy Curls', subcopy: 'Textured hair care built for your pattern', cta: 'Shop Textured Hair', tone: 'Bold', hasOffer: true, offerBadge: 'Buy 2 Get 1', complianceStatus: 'approved', reasoning: 'Textured hair care resonates with creative expressers', image: '/images/textured_hair_care/SBS-459068.jpg', approved: false },
    { id: 'cr-3', segmentId: 'seg-3', segmentName: 'Professional Stylists', headline: 'Pro Nails, Perfect Results', subcopy: 'Salon-grade nail essentials for professionals', cta: 'Shop Nails & Essentials', tone: 'Professional', hasOffer: true, offerBadge: 'Buy 5 Get 5', complianceStatus: 'approved', reasoning: 'High-volume nail essentials drive replenishment for pros', image: '/images/nails/SBS-011313.jpg', approved: false },
    { id: 'cr-4', segmentId: 'seg-4', segmentName: 'First-Time Stylists', headline: 'Your Style Journey Starts Here', subcopy: 'Easy grooming & styling products for beginners', cta: 'Explore Grooming', tone: 'Encouraging', hasOffer: true, offerBadge: 'Get $20 off', complianceStatus: 'pending', reasoning: 'Beginner-friendly grooming messaging reduces hesitation', image: '/images/mens_grooming/SBS-395010.jpg', approved: false },
  ],
  'Hair Care': [
